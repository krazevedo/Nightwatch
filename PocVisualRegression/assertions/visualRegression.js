                ...
                .onComplete(function(data){
                    ...
                    if (!self.pass(self.value(data))) {
                        ...
                        try {
                            ...
                            data.getDiffImage().pipe(fse.createWriteStream(errorFilename));
                        } catch(e) {
                            console.log(e);
                        }

                        self.message = util.format('Visual Regression: Screen differs by %s% (see: %s)', self.value(data), errorFilename);
                    }
